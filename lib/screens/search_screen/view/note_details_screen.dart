                      ...
                      child: Align(
                        ...
                        child: SizedBox(
                          ...
                          width: bubbleUser.name.length <= 5
                              ? widget.size.width * 0.71
                              : bubbleUser.name.length <= 7
                                  ? widget.size.width * 0.76
                                  : widget.size.width * 0.79,
                          child: Stack(
                            children: [
                              Padding(
                                    ...
                                    child: Row(
                                      children: [
                                        CircleAvatar(
                                          radius: 15,
                                          backgroundImage:
                                              NetworkImage(bubbleUser.photoUrl),
                                        ),
                                        const SizedBox(
                                          width: 5,
                                        ),
                              ...
                              Positioned(
                                  left: bubbleUser.name.length <= 5
                                      ? widget.size.width * 0.27
                                      : bubbleUser.name.length <= 7
                                          ? widget.size.width * 0.33
                                          : widget.size.width * 0.36,
                                  top: 4,
                                  child: Container(
